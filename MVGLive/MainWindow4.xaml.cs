...
namespace MVGLive
{
    ...
    public partial class MainWindow4 : Window
    {
        ...
        public MainWindow4()
        {
            ...
            Table1.SetProperties(App.FontFamily, Directions[0], 16, 2, (int)UserFontSize);
            Table1.Start();

            Table2.SetProperties(App.FontFamily, Directions[1], 16, 6, (int)UserFontSize);
            Table2.Start();

            Table3.SetProperties(App.FontFamily, Directions[2], 16, 10, (int)UserFontSize);
            Table3.Start();

            Table4.SetProperties(App.FontFamily, Directions[3], 16, 14, (int)UserFontSize);
            Table4.Start();
            ...
            Table4.ConnectionStatusChangedEvent += Table4_ConnectionStatusChangedEvent;
            ...
            Text4.FontFamily = App.FontFamily;
            Text4.FontSize = UserFontSize * 1.3f;
        ...
        private void Table4_ConnectionStatusChangedEvent(object sender, EventArgs e)
        {
        }

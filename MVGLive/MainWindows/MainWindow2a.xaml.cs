...
namespace MVGLive
{
    ...
    /// </summary>
    public partial class MainWindow2a : Window
    {
        ...
        public MainWindow2a()
        {
            ...
            Table1.DataContext = new DeparturesViewModel(Directions[0], App.TableFontFamily, (int)UserFontSize, 16, 2);
            Table2.DataContext = new DeparturesViewModel(Directions[0], App.TableFontFamily, (int)UserFontSize, 16, 10);

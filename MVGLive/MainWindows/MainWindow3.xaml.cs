...
namespace MVGLive
{
    ...
    public partial class MainWindow3 : Window
    {
        ...
        public MainWindow3()
        {
            ...
            InitializeComponent();
            this.PreviewKeyUp += MainWindow3_PreviewKeyUp;
            MainCommon.SetupTables(new System.Windows.Controls.Label[] { Text1, Text2, Text3 }, new MVGTimeTable.MVGTimeTable[] { Table1, Table2, Table3 });
        ...
        private void MainWindow3_PreviewKeyUp(object sender, System.Windows.Input.KeyEventArgs e)
        {
